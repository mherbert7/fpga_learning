...
HD_PWD='C:/Users/Marcus/Desktop/Arty/FFT/FFT/FFT.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log tester.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source tester.tcl -notrace
