...
HD_PWD='C:/Users/Marcus/Desktop/Arty/FFT/FFT/FFT.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tester.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tester.tcl
